        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects can return cleanup functions, which can clean up timers using memory, listeners to outside API's, and other function which may use system resources</li>
                </ul>
                <SampleEffect />
                <br />
                <SampleEffect />
