        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <dl>
                    ...
                    <dt>Not required</dt>
                    <dd>You can write in vanilla JS, bust most people use JSX</dd>
                </dl>
                <hr />
            </div>
            <NormalComponent />
...
const NormalComponent = () => {
    return(
        <div style={{ border: '2px solid black' }}>
            ...
            <img alt='jsx' src='https://pbs.twimg.com/media/DOzL82mXkAA0zFs.jpg' />
        </div>
    );
};
...
const CreateElementComponent = () => {
    return(
        ...
        React.createElement('img', { alt: 'react', src: 'https://cdn-images-1.medium.com/max/1200/1*jJZHFQmhkq_7ohn18KrMhA.png' }, null)
        )
    );
};
